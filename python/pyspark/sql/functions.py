...
class UserDefinedFunction(object):
    ...
    .. versionadded:: 1.3
    """
    def __init__(self, func, returnType, nullable=True, name=None):
        self.func = func
...
@since(1.3)
def udf(f, returnType=StringType(), nullable=True, name=None):
    ...
    """
    return UserDefinedFunction(f, returnType, nullable, name)
